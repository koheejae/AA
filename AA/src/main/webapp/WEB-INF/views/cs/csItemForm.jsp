  ...
  <form name="itemForm" method="post"   action="${contextPath}/cs/csAddNewItem.do"   enctype="multipart/form-data"  style="margin-left:200px;">
    <table border="0" align="center" style="margin-left:100px;">
     ...
     <tr>
			  ...
			  <td> <input type="file" name="imageFileName" style="margin-left:40px;"  onchange="readURL(this);" /></td>
			  <td><img  id="preview" src="#"   width=200 height=200 style="margin-left:40px;"/></td>
		</tr>
         <tr>  
			  <td align="center">이미지파일 첨부</td>
