...
<table  width=1000px;   class="list_view" style=" margin-left:280px;">
  ...
  <c:choose> 
     <c:when test="${not empty article.imageFileName && article.imageFileName!='null' }">
       ...
       <c:otherwise>
          <td colspan="3" style="text-align:left; max-height:1000px; width:660; max-width:660px; height:200px; padding:10; padding-left:50px; padding-right:50px; word-break:break-all; border-top:0.5px solid rgb(245, 215, 0);">
              ${article.board_content }
             </td>
       </c:otherwise> 
    </c:choose>
